...
`;
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed bottom-4 right-4 w-[400px] max-w-md h-[550px] flex flex-col rounded-2xl overflow-hidden shadow-2xl border border-amber-800/30 bg-slate-900/90 backdrop-blur-xl z-50">
          {/* Header */}
