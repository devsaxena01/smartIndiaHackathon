      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-center md:text-left">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li className="hover:text-white cursor-pointer">Interactive Map</li>
            <li className="hover:text-white cursor-pointer">Digital Archives</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li className="hover:text-white cursor-pointer">Cultural Calendar</li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li className="hover:text-white cursor-pointer">Preservation Efforts</li>
          </ul>
          <button className="mt-4 border border-gray-600 px-4 py-2 rounded-md hover:bg-gray-800 w-full md:w-auto">
            Contact Us
          </button>
        </div>
      </div>
