...
const Home = () => {
  ...
  const [messages, setMessages] = useState([
    { sender: "bot", text: "Hello! How can I help you with Monastery360 today?" },
  ]);
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...prev,
        { sender: "bot", text: "Thanks for your question! We'll get back to you soon." },
      ]);
    }, 500);
  ...
  return (
    <div className="bg-gray-900 text-gray-300 font-sans relative min-h-screen">
      {/* Hero Section */}
      <section
      ...
      >
        ...
        >
          ...
          >
            Embark on an immersive digital journey through the ancient
            monasteries and vibrant culture of Sikkim. Explore panoramic virtual
            tours, interactive maps, and a rich archive of historical treasures.
          </motion.p>
          ...
          >
            <div>
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                Buddhist traditions, adorned with countless monasteries that
                serve as centers of learning, worship, and cultural
                preservation. These sacred sites, from the grandeur of Rumtek to
                the ancient serenity of Pemayangtse, are not just architectural
                marvels but living testaments to a spiritual legacy passed down
                through generations.
                <br /> <br />
            ...
            <button
              className="mt-6 bg-orange-700 hover:bg-orange-600 text-white px-5 py-2 rounded-md transition"
      ...
      <section className="relative bg-gradient-to-r from-orange-600 via-red-500 to-blue-600 text-white py-20 px-6 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <p className="max-w-2xl mx-auto text-lg md:text-xl mb-8 text-gray-100 leading-relaxed">
            Join us on a journey of discovery. Dive into immersive virtual
            tours, plan your visit, and explore our sacred preservation efforts.
          </p>

          {/* Button */}
          <button
            className="bg-white text-black font-semibold px-8 py-3 rounded-lg shadow-md hover:shadow-xl hover:scale-105 transition duration-300"
            onClick={() => navigate("/")}
          >
            Start Your Journey
          </button>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 bg-gray-800 hover:bg-orange-500 text-white p-4 rounded-full shadow-lg z-50"
      >
        💬
      </button>
      ...
      {/* Chat Window */}
      {isChatOpen && (
        <div className="fixed bottom-20 right-6 w-[350px] h-[400px] bg-gray-800 rounded-lg shadow-lg flex flex-col z-50">
          {/* Header */}
          <div className="flex justify-between items-center bg-orange-600 text-white px-4 py-2 rounded-t-lg">
          ...
          <div className="flex items-center border-t border-gray-700">
            <input
              ...
              className="flex-grow px-3 py-2 bg-gray-700 text-white text-sm rounded-bl-lg outline-none"
            />
            <button
              onClick={handleSend}
              className="px-4 py-2 bg-orange-600 hover:bg-orange-500 text-white rounded-br-lg"
            >
              ➤
            </button>
          </div>
