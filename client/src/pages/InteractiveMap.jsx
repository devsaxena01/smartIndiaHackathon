...
const InteractiveMap = () => {
  ...
  const [resetKey, setResetKey] = useState(0); // 👈 state for reset
  ...
  const monasteryData = {
    ...
    description:
      "Rumtek Monastery is one of the most significant monasteries in Sikkim, showcasing traditional Tibetan architecture and housing rare Buddhist scriptures and artifacts.",
    tags: ["Buddhist", "Heritage", "Tibetan"],
    image:
      "https://z-cdn-media.chatglm.cn/files/1aeb731c-aa76-4cf4-b05e-a40b33630b88_WhatsApp%20Image%202025-09-13%20at%2000.26.20_bf63c5a3.jpg?auth_key=1789239965-c429d1035dec46f9b0b84d3eea49407b-0-1063ca3ad80bc1a31ad8e0fec8ae2645",
  };

  const handleReset = () => {
    setResetKey((prev) => prev + 1); // forces iframe reload
  };
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3 bg-white rounded-xl shadow-md overflow-hidden">
            <div className="relative h-96 md:h-[500px] bg-amber-100">
              {/* Iframe with reset functionality */}
              <iframe
                key={resetKey} // 👈 key forces reload on reset
                src="https://www.google.com/maps/embed?pb=!4v1757958965137!6m8!1m7!1sCAoSF0NJSE0wb2dLRUlDQWdJQ2t2ZXZVaXdF!2m2!1d27.28884361783851!2d88.56089980788117!3f130.35102225581767!4f9.534563155972833!5f0.7820865974627469"
                title="Sikkim Map"
              ...
              {/* Custom map markers (optional static overlays) */}
